...
namespace ApiProyecto1002.Controllers
{
    ...
    [ApiController]
    public class GestoresControler : ControllerBase
    {
        private readonly AppDbContext context;

        public GestoresControler(AppDbContext context)
        {
            this.context = context;
        }
        // GET: api/<GestoresControler>
        [HttpGet]
        ...
        // DELETE api/<GestoresControler>/5
        [HttpDelete("{id}")]
